...
// Threshold
const float kReconstructionErrorThreshold = 2.8;
...
void loop() {
  ...
  if (IMU.accelerationAvailable()) {
    ...
    window_buffer[sample_index][0] = x * 9.81f;
    window_buffer[sample_index][1] = y * 9.81f;
    window_buffer[sample_index][2] = z * 9.81f;
